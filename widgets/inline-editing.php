...
class Inline_Editing extends Widget_Base {
	...
	public function get_title() {
		return __( 'Inline Editing', 'sip-finmc-button' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'title',
			[
				'label' => __( 'Title', 'sip-finmc-button' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Title', 'sip-finmc-button' ),
			]
		);
		...
		$this->add_control(
			'description',
			[
				'label' => __( 'Description', 'sip-finmc-button' ),
				'type' => Controls_Manager::TEXTAREA,
				'default' => __( 'Description', 'sip-finmc-button' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Content', 'sip-finmc-button' ),
			]
		);
